...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username){
        ...
        JLabel l11 = new JLabel("UPDATE CUSTOER DETAILS");
        ...
        b2.setBounds(330,430,100,25);
        b2.addActionListener(this);
        add(b2);
        
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("travel/hotel/managementsystem/icons/update.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== b1){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Customer Details Upadate Successfully");
